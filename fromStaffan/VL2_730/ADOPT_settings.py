...
InternalControlAssemblies    = 19       # Number of control-assemblies located inside the core [#]
...
## NEUTRON HISTORIES
SerpentCylNeutrons       = 2000   # Number of neutrons [#]
SerpentCylActiveCycles   = 120    # Number of active (stored) cycles [#]
...
stage1_activecycles   = 230           # Number of cycles stored
...
stage2_neutrons       = 5500         # Number of neutrons per cycle
stage2_activecycles   = 520          # Number of cycles stored
stage2_inactivecycles = 20           # Number of cycles discarded
...
eqcycle_kefftarget = 1.00    # The target keff for criticality search (almost always 1.00 + x)
...
iter_convergence = 5 * Batches  # Maximum amount of iterations before breaking eq. cycle search
