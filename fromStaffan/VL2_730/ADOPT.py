...
if EDIS == "on":
	...
	for iteration in range(stage1_iterations):
		...
		if keff_max < keff_convergence and materr < mat_convergence:
			...
			if version == 2:
				...
				bustuff1(orgfilename, AxialZones, eqcycle_batches, where, shufflescheme, VOLUMES, matnames, eqcycle_days, eqcycle_busteps)		
	...
	if criticality == "on":
		...
		eqcycle_days1 = runcriticality(eqcycle_busteps, eqcycle_days, keff0, keff1, criticalitytries, eqcycle_kefftarget, eqcycle_days1)
		...
		for iteration in range(stage1_iterations):
			...
			if keff_max < keff_convergence and materr < mat_convergence:
				...
				if version == 2:
					...
					bustuff1(orgfilename, AxialZones, eqcycle_batches, where, shufflescheme, VOLUMES, matnames, eqcycle_days1, eqcycle_busteps)
			...
			# Read the multiplication factor results
			read_results(s1file, KEFF_LIST, KEFFSD_LIST, iteration, stage, stage1_iterations, stage2_iterations, serptime, where)
		...
		if converged != 1:
			...
			for x in range(stage2_iterations):
				...
				# Read the multiplication factor results
				read_results(s2file, KEFF_LIST, KEFFSD_LIST, iteration, stage, stage1_iterations, stage2_iterations, serptime, where)
		...
		eqcycle_days2 = runcriticality(eqcycle_busteps, eqcycle_days, keff0, keff1, criticalitytries, eqcycle_kefftarget, eqcycle_days1)
		...
		for iteration in range(stage1_iterations):
			...
			if keff_max < keff_convergence and materr < mat_convergence:
				...
				if version == 2:
					...
					bustuff1(orgfilename, AxialZones, eqcycle_batches, where, shufflescheme, VOLUMES, matnames, eqcycle_days2, eqcycle_busteps)
			...
			# Read the multiplication factor results
			read_results(eq1file, KEFF_LIST, KEFFSD_LIST, iteration, stage, stage1_iterations, stage2_iterations, serptime, where)
		...
		if converged != 1:
			...
			for x in range(stage2_iterations):
				...
				# Read the multiplication factor results
				read_results(eq2file, KEFF_LIST, KEFFSD_LIST, iteration, stage, stage1_iterations, stage2_iterations, serptime, where)
