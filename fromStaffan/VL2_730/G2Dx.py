...
resfile     = open("resfile.txt",'w', encoding='utf-8')
...
resfile.write("------- POWER -----------------------------------")
resfile.write("\n")
resfile.write("  Max. radial peaking:        {0:02.2f}".format(MaximumRadialPeakingFactor))
resfile.write("\n")
resfile.write("  Ave. radial peaking:        {0:02.2f}".format(AverageRadialPeakingFactor))
resfile.write("\n")
resfile.write("  Min. radial peaking:        {0:02.2f}".format(MinimumRadialPeakingFactor))
resfile.write("\n")
resfile.write("  Max. peak axial peaking:    {0:02.2f}".format(max(MaxAxPeak)))
resfile.write("\n")
resfile.write("  Ave. axial peaking:         {0:02.2f}".format(RealAveAx))
resfile.write("\n")
resfile.write("  Min. axial peaking:         {0:02.2f}".format(min(MinAxPeak)))
resfile.write("\n")
resfile.write("  Maximum batch power:        {0:02.1f}".format(MaximumBatchPower) + " MW")
resfile.write("\n")
resfile.write("  Change in max. batch power: {0:02.1f}".format(ChangeinMaxPowerBatch) + " MW")
resfile.write("\n")
resfile.write("--------------------------------------------------")
resfile.write("\n")
resfile.write("")
resfile.write("\n")
resfile.write("------- BURNUP -----------------------------------")
resfile.write("\n")
resfile.write("  Average discharge burnup: {0:02.1f}".format(AverageDischargeBurnup) + " MWd/kg")
resfile.write("\n")
resfile.write("  Peak discharge burnup:    {0:02.1f}".format(PeakDischargeBurnup)    + " MWd/kg")
resfile.write("\n")
resfile.write("  Burnup peaking:           {0:02.2f}".format(PeakDischargeBurnup/AverageDischargeBurnup))
resfile.write("\n")
resfile.write("--------------------------------------------------")
resfile.write("\n")
resfile.write("")
resfile.write("\n")
resfile.write("------- FLUENCE ----------------------------------")
resfile.write("\n")
resfile.write("  Average discharge fluence: {0:02.2f}".format(AverageFluence/1e23) + " x 1e23 n/cm^2")
resfile.write("\n")
resfile.write("  Peak discharge fluence:    {0:02.2f}".format(PeakFluence/1e23)    + " x 1e23 n/cm^2")
resfile.write("\n")
resfile.write("  Fluence peaking:           {0:02.2f}".format(PeakFluence/AverageFluence))
resfile.write("\n")
resfile.write("--------------------------------------------------")
resfile.write("\n")
resfile.write("")
...
resfile.write("------- DPA --------------------------------------")
resfile.write("\n")
resfile.write("  Average discharge DPA: {0:02.0f}".format(AverageFluence*dpaxs))
resfile.write("\n")
resfile.write("  Peak discharge DPA:    {0:02.0f}".format(PeakFluence*dpaxs))
resfile.write("\n")
resfile.write("--------------------------------------------------")
resfile.write("")