...
COMPLETE_DATE             (idx, [1: 24])  = 'Sun Oct 15 20:58:08 2017' ;
...
OMP_HISTORY_PROFILE       (idx, [1:  20]) = [  9.97660E-01  9.96478E-01  1.01207E+00  9.96130E-01  9.93546E-01  1.00151E+00  9.98032E-01  9.95499E-01  9.98231E-01  1.00929E+00  9.99739E-01  1.00015E+00  1.01746E+00  1.01830E+00  1.01177E+00  9.91023E-01  9.89608E-01  9.95669E-01  9.92305E-01  9.85530E-01  ];
...
TOT_CPU_TIME              (idx, 1)        =  5.66939E+04 ;
RUNNING_TIME              (idx, 1)        =  3.23264E+03 ;
INIT_TIME                 (idx, [1:  2])  = [  8.81150E-01  8.81150E-01 ];
PROCESS_TIME              (idx, [1:  2])  = [  1.03385E+00  1.03385E+00 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  3.23072E+03  3.23072E+03  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  2.32933E-01  7.26333E-02 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  3.23256E+03  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 17.53794 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  1.80654E+01 0.00016 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  8.69500E-01 ;

% Memory usage:

AVAIL_MEM                 (idx, 1)        = 63996.67 ;
ALLOC_MEMSIZE             (idx, 1)        = 19247.71;
MEMSIZE                   (idx, 1)        = 16197.73;
XS_MEMSIZE                (idx, 1)        = 878.77;
MAT_MEMSIZE               (idx, 1)        = 195.11;
RES_MEMSIZE               (idx, 1)        = 6690.10;
MISC_MEMSIZE              (idx, 1)        = 1567.30;
UNKNOWN_MEMSIZE           (idx, 1)        = 6866.46;
UNUSED_MEMSIZE            (idx, 1)        = 3049.98;
...
BALA_NEUTRON_DIFF            (idx, [1:  2])  = [ 0 7.42149E-03 ];
